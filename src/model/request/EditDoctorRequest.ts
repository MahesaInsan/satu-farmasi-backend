...
export default class EditDoctorRequest extends BaseEditUserRequest {
	...
	constructor(id: number, nik: string, email: string, password: string, firstName: string, lastName: string, dob: Date, phoneNum: string, role: Role, is_active: boolean, createdAt: Date, updatedAt: Date, specialist: string) {
